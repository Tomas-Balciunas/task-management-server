 ...
 */
final class Version20250213173035 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task ADD assigned_to_id INT DEFAULT NULL, ADD assigned_by_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE task DROP assigned_to_id, DROP assigned_by_id');
    }
}
